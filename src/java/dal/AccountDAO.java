...
public class AccountDAO extends DBContext {
    ...
    public void addNewAcc(String fullname, String email, String phonenumber, String password, String role) {
        ...
        if (role.equalsIgnoreCase("Seller")) {
            sql = "INSERT INTO " + role + " (full_name, img_url, email, phone_number, password, address, status)\n"
                + "VALUES (?, 'aaa', ?, ?, ?, 'aaa', 1)";
        } else {
            sql = "INSERT INTO " + role + " (full_name, email, phone_number, password, address, status)\n"
                + "VALUES (?, ?, ?, ?, 'aaa', 1)";
        }
